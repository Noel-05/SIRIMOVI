...
public class ClienteController {
    ...
    //  CONSULTAR INFORMACION COMERCIAL
    // Mostrar los datos de una persona en el JSP por su ID
    @RequestMapping(value = "/getInformacionComercial", method = RequestMethod.GET)
    public String getInformacionComercial(@RequestParam("id") int id, Model model) {
        System.out.println("--> Recuperando informacion Comercial con ID: " + id);
        ...
        // Esto es para enviar al JSP de WEB-INF/jsp/obtenerInformacionComercial.jsp
