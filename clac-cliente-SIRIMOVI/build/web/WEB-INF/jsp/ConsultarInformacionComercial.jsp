            ...
            <div class="card border-dark">
                ...
                <div class="card-body">
                    <table class="table table-hover text-center">
                        ...
                        <thead>
                            <tr>
                                <th class="text-center" style="color:red"><strong> Id Comercial </strong></th>
                        ...
                        <tbody>
                            <c:forEach var="informacionComercial" items="${informacionComercialGetAll}">
                                <c:url var="editUrl" value="/update?id=${informacionComercial.id}" />
                                <c:url var="getUrl" value="/get?id=${informacionComercial.id}" />
                                
                                <tr>
                                    <td><c:out value="${informacionComercial.idco}" /></td>
                                    <td><c:out value="${informacionComercial.idor}" /></td>
                                    <td><c:out value="${informacionComercialmonitoreo.depa}" /></td>
                                    <td><c:out value="${informacionComercial.paises}" /></td>
                                    <td><c:out value="${informacionComercial.empresas}" /></td>
                                    <td>
