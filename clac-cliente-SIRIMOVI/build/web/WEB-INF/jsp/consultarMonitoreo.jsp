            ...
            <div class="card border-dark">
                ...
                <div class="card-body">
                    <table class="table table-hover text-center">
                        ...
                        <thead>
                            <tr>
                                <th class="text-center" style="color:red"><strong> Id Monitoreo </strong></th>
                                <th class="text-center" style="color:red"><strong> Id informacion organizacional </strong></th>
                                <th class="text-center" style="color:red"><strong> Cantidad de Produccion </strong></th>
                        ...
                        <tbody>
                            <c:forEach var="monitoreo" items="${monitoreosGetAll}">
                                <c:url var="editUrl" value="/update?id=${monitoreo.id}" />
                                <c:url var="deleteUrl" value="/delete?id=${monitoreo.id}" />
                                <c:url var="getUrl" value="/get?id=${monitoreo.id}" />
                                
                                <tr>
                                    <td><c:out value="${monitoreo.id}" /></td>
                                    <td><c:out value="${monitoreo.idInfo}" /></td>
                                    <td><c:out value="${monitoreo.cantP}" /></td>
                                    <td><c:out value="${monitoreo.cantPer}" /></td>
                                    <td><c:out value="${monitoreo.total}" /></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="${deleteUrl}" class="btn btn-danger btn-sm" title="Eliminar Monitoreo" onclick="return confirm('¿Seguro que desea eliminar esté registro?')"> 
